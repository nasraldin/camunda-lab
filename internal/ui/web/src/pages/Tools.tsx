  ...
  return (
    <div className="stack">
      <div className="page-head">
        <h1>Extras</h1>
        <p className="lead">
          Optional helpers for Desktop Modeler and deploying process diagrams. Skip this if you only use the web apps.
        </p>
      </div>
      ...
      <div className="card stack">
        ...
        <p className="hint">Create a connection named camunda-lab so Desktop Modeler can talk to this lab.</p>
        <button
          type="button"
          disabled={!!busy}
          onClick={async () => {
      ...
      <div className="card stack">
        ...
        <p className="hint">Needs the deploy tool above. Choose a .bpmn file to send it to your lab.</p>
        <input
          type="file"
          accept=".bpmn,.BPMN"
