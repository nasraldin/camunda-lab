  ...
  return (
    <div className="stack">
      <div className="page-head">
        <h1>Logins</h1>
        <p className="lead">
          Default usernames and passwords for this local lab. After one Keycloak sign-in, Camunda
          apps usually stay open in this browser — manage that from <Link to="/apps">Apps</Link>{' '}
          (Sign out / Fix broken session).
        </p>
      </div>

      <div className="banner info">
        For practice on your computer only. Do not reuse <code>demo</code> / <code>admin</code> on
        real systems.
      </div>
            ...
            <div className="kv-list">
              <div className="kv">
                ...
                <button
                  type="button"
                  className="btn-sm"
                  onClick={() => void copy(c.username, `${c.id}-u`)}
                >
              ...
              <div className="kv">
                ...
                <button
                  type="button"
                  className="btn-sm"
                  onClick={() => void copy(c.password, `${c.id}-p`)}
                >
      ...
      <div className="card stack">
        ...
        <p className="hint">
          ...
          <strong>demo / demo</strong> for apps and <strong>admin / admin</strong> for Keycloak on a
          full lab. If you changed them, reset the lab and install again.
        </p>
        <ol className="steps">
          <li>
          ...
          <li>
            To recreate the original demo users, delete the lab and install again from Get started.
          </li>
        </ol>
        <div className="row">
      ...
      {showReset && (
        <Modal title="Restore default logins" onClose={() => setShowReset(false)}>
          ...
          <ol className="steps">
            <li>
              Open <Link to="/danger">Reset lab</Link> and delete everything (type DELETE), or in a
              terminal run <code>camunda nuke --yes</code>
            </li>
            <li>
              Install again from <Link to="/setup">Get started</Link>.
            </li>
            <li>
              Sign in with <code>demo / demo</code> (and Keycloak <code>admin / admin</code> on a
              full lab).
            </li>
          </ol>
