...
export function IconContainers(p: IconProps) {
  return (
    <svg className={p.className} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M12 3 3 7.5 12 12l9-4.5L12 3Z" stroke="currentColor" strokeWidth="1.75" strokeLinejoin="round" />
      <path d="M3 12.5 12 17l9-4.5M3 17.5 12 22l9-4.5" stroke="currentColor" strokeWidth="1.75" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconLogs(p: IconProps) {
  return (
    <svg className={p.className} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M6 5h12M6 10h12M6 15h8M6 20h5" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconAI(p: IconProps) {
  return (
    <svg className={p.className} viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      <path d="M12 3v2.5M12 18.5V21M4.2 6.2l1.8 1.8M18 16l1.8 1.8M3 12h2.5M18.5 12H21M4.2 17.8 6 16M18 8l1.8-1.8" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconTools(p: IconProps) {
  return (
    <svg className={p.className} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="m14.7 6.3 2.5-2.5 3 3-2.5 2.5M4 20l5-5" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" />
      <path d="M14.5 6.5a4.2 4.2 0 0 0-5.9 5.9L4 17l3 3 4.6-4.6a4.2 4.2 0 0 0 5.9-5.9" stroke="currentColor" strokeWidth="1.75" />
    </svg>
  );
}
...
export function IconAdmin(p: IconProps) {
  return (
    <svg className={p.className} viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      <path d="M5 19c1.5-3.2 3.8-4.8 7-4.8s5.5 1.6 7 4.8" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconDanger(p: IconProps) {
  return (
    <svg className={p.className} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M12 3 2 21h20L12 3Z" stroke="currentColor" strokeWidth="1.75" strokeLinejoin="round" />
...
export function IconExternal(p: IconProps) {
  return (
    <svg className={p.className} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M14 5h5v5M19 5 10 14" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" />
      <path d="M11 5H6a2 2 0 0 0-2 2v11a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2v-5" stroke="currentColor" strokeWidth="1.75" />
    </svg>
  );
}
...
export function IconDocs(p: IconProps) {
  return (
    <svg className={p.className} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M5 4.5A1.5 1.5 0 0 1 6.5 3H14l5 5v11.5a1.5 1.5 0 0 1-1.5 1.5h-11A1.5 1.5 0 0 1 5 19.5v-15Z" stroke="currentColor" strokeWidth="1.75" strokeLinejoin="round" />
      <path d="M14 3v5h5M8 12h8M8 16h6" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function OptimizeIcon(p: IconProps) {
  return (
    <svg className={p.className} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M4 18V8l5 4 4-7 7 11" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
function IdentityIcon(p: IconProps) {
  return (
    <svg className={p.className} viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      <path d="M5.5 19c1.6-3 4-4.5 6.5-4.5S17 16 18.5 19" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
function ModelerIcon(p: IconProps) {
  return (
    <svg className={p.className} viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      <path d="M10 8.5h4M14 8.5v4.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
function KeycloakIcon(p: IconProps) {
  return (
    <svg className={p.className} viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      <path d="M12.2 12H20v2.2h-2V17h-2.2v-2.8H12.2" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
    </svg>
  );
}
function ConnectorsIcon(p: IconProps) {
  return (
    <svg className={p.className} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M8 8h3a3 3 0 0 1 0 6H8M16 8h-3a3 3 0 0 0 0 6h3" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
function ElasticIcon(p: IconProps) {
  return (
    <svg className={p.className} viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      <path d="M5 7v5c0 1.4 3.1 2.6 7 2.6s7-1.2 7-2.6V7M5 12v5c0 1.4 3.1 2.6 7 2.6s7-1.2 7-2.6v-5" stroke="currentColor" strokeWidth="1.7" />
    </svg>
  );
}
function ApiIcon(p: IconProps) {
  return (
    <svg className={p.className} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M8 8 4 12l4 4M16 8l4 4-4 4M13 6l-2 12" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
function McpIcon(p: IconProps) {
  return (
    <svg className={p.className} viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      <path d="M11 7.5h2.5V11M13 16.5H10.5V13" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
function AdminIcon(p: IconProps) {
  return (
    <svg className={p.className} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M12 3 4 6v5c0 4.5 3.2 8.4 8 9.5 4.8-1.1 8-5 8-9.5V6l-8-3Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
    </svg>
  );
}
...
export function AppGlyph({ name, size = 44 }: { name: string; size?: number }) {
  ...
  return (
    <span className="app-glyph" style={{ width: size, height: size, background: meta.color }} aria-hidden>
      {!failed ? (
        <img
