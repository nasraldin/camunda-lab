      ...
      <nav className="nav" aria-label="Lab">
        ...
        <div className="nav-foot">
          ...
          <div className="nav-foot-links" aria-label="Project links">
            <a href={PROJECT.repo} target="_blank" rel="noreferrer" title="GitHub" aria-label="GitHub repository">
              <IconGitHub />
            </a>
            <a href={PROJECT.docs} target="_blank" rel="noreferrer" title="Lab help docs" aria-label="Camunda Lab help docs">
              <IconDocs />
            </a>
            <a
            ...
            <a href={PROJECT.releases} target="_blank" rel="noreferrer" title="Releases" aria-label="GitHub releases">
              <IconReleases />
            </a>
          </div>
          {cliVersion && <div className="nav-foot-version">Version v{cliVersion.replace(/^v/, "")}</div>}
        </div>
      </nav>
      <main className="main">
        <Routes>
