...
Current release: **[v0.7.0](https://github.com/nasraldin/camunda-lab/releases/tag/v0.7.0)** (platform toolkit, monitoring add-on, visual BPMN lint, Camunda 8.7–8.10).
